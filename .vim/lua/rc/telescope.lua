...
local keymaps = function()
  ...
  vim.keymap.set('n', '<C-t>p', function() require('telescope').extensions.frecency.frecency({ workspace = 'CWD' }) end,
    { silent = true })
  vim.keymap.set('n', '<C-p>', function() require('telescope').extensions.frecency.frecency({ workspace = 'CWD' }) end,
    { silent = true })
