...
func! z#constants#globals#Ft()
  let g:zft = {
      ...
      \'cx':     ['c', 'cpp', 'objc', 'objcpp', 'ch', 'm', 'mm', 'h', 'hpp'],
      \'jinja':  ['jinja', 'jinja.html', 'sls'],
      \'markup': ['xml', 'html', 'jinja.html', 'xhtml', 'svg'],
      \'styles': ['css', 'sass', 'scss', 'less', 'stylus'],
      \'jade':   ['jade', 'pug'],
      \'image':  ['jpg', 'jpeg', 'gif', 'png', 'ico'],
      \'config': ['toml', 'yaml', 'yml', 'json', 'jsonc', 'json5', 'markdown', 'md', 'apiblueprint', 'ini', 'cfg', 'conf', 'env'],
      \'scpt':   ['applescript', 'osascript'],
      \'clj':    ['clojure', 'clojurescript'],
      \'sql':    ['sql', 'pgsql', 'mysql', 'plsql'],
      \'vim':    ['vim', 'vimscript'],
      \'rs':     ['rust'],
      ...
      \'make':   ['makefile', 'Makefile', 'make', 'mk', 'mak'],
      \'java':   ['java', 'jsp', 'jspx'],
